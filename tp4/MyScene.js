...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.textureFront = new CGFtexture(this, 'images/mineSide.png');
        this.textureRight = new CGFtexture(this, 'images/mineSide.png');
        this.textureBack = new CGFtexture(this, 'images/mineSide.png');
        this.textureLeft = new CGFtexture(this, 'images/mineSide.png');
        this.textureBottom = new CGFtexture(this, 'images/mineBottom.png');

        this.myUnitCubeQuad = new MyUnitCubeQuad(this, this.myQuad, this.textureTop, this.textureFront, this.textureBack, this.textureLeft, this.textureBottom);
